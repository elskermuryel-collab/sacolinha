...
#    4) assim que o build termina, o app publicado no GitHub fica com uma
#       versao nova -- e o proprio celular (com o app ja instalado) detecta
#       isso sozinho na proxima vez que a pessoa abrir ou voltar pro app, e
#       mostra um pop-up perguntando "Sim, atualizar" / "Agora nao". Se
#       clicar "Sim", o proprio app baixa o APK novo e ja abre a tela de
#       instalacao do Android sozinho -- so falta tocar em "Instalar" (essa
#       ultima confirmacao e do proprio Android, nenhum app consegue pular
#       ela, e' seguranca do sistema). Nao precisa fazer mais nada por aqui.
